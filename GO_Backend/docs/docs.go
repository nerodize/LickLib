        ...
        "/tracks": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Audiodatei (MP3/WAV/FLAC, max 100MB)",
                        "name": "trackFile",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Titel (3-200 Zeichen)",
                        "name": "title",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Beschreibung (10-2000 Zeichen)",
                        "name": "description",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "EASY|MEDIUM|HARD|GOGGINS",
                        "name": "difficulty",
                        "in": "formData"
                    }
                ],
        ...
        "/tracks/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update-Felder",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.UpdateTrackRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/users": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Username (min 3 Zeichen)",
                        "name": "username",
                        "in": "formData",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "models.Notation": {
            ...
            "properties": {
                ...
                "content": {
                    "description": "Tab oder Noten als Text/JSON",
                    "type": "string"
                },
                "createdAt": {
                    "type": "string"
                ...
                "type": {
                    "description": "\"TABS\" | \"NOTES\"",
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.NotationType"
                        }
                    ]
                },
                "updatedAt": {
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "first_name": {
                    "description": "PasswordHash string     ` + "`" + `gorm:\"column:password_hash;type:text;not null\" json:\"-\"` + "`" + `",
                    "type": "string"
                },
                "id": {
                    "type": "string"
